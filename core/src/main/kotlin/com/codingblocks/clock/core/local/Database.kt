...
import com.codingblocks.clock.core.local.dao.NFTLogoDao
...
@Database(
    entities = [PositionFTLocal::class, PositionNFTLocal::class, PositionLPLocal::class, WatchListConfig::class, FeedFT:: class, FeedNFT::class, CustomFTAlert::class, CustomNFTAlert::class, TokenLogo::class, NFTLogo::class, NFTStatsEntity::class, FTPriceEntity::class, FeedToClockItem::class],
    version = 5,
    exportSchema = false
)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun getTokenLogoDao(): TokenLogoDao
    abstract fun getNFTLogoDao(): NFTLogoDao
